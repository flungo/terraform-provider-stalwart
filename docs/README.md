...
Reference material for contributors to this Terraform provider.
...
| [decisions/](decisions/README.md) | Design decision log (ADR-style) |

The top-level [CLAUDE.md](../CLAUDE.md) contains operational rules for AI coding sessions (branch workflow, environment constraints).
Start there if you are an AI agent.
